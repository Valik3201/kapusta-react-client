...
const LoginForm = () => {
  ...
  return (
    <div className="md:w-[426px] bg-white shadow-form rounded-3xl px-20 py-14">
      <h2 className="text-gray-darkest text-xs text-center">
        You can log in with your Google Account:
      </h2>
      <button className="block mx-auto bg-gray-light-2 rounded-full shadow-google mt-5 mb-8 px-5 py-3">
      ...
      <form onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="grid grid-cols-2 gap-4 mt-10">
          <button
            onClick={handleLogin}
            className="bg-gray-light text-gray-darkest p-2 rounded-2xl shadow-form-btn hover:bg-orange hover:text-white hover:shadow-form-btn-hover transition duration-200 ease-in-out"
          >
            Log in
          </button>
          <button
